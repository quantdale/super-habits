...
describe('in-app notice store', () => {
  ...
  it('keeps the newest notice first', () => {
    ...
    const state = enqueueInAppNotice(enqueueInAppNotice(createInAppNoticeState(), first), second);
  ...
  it('dismisses notices by id', () => {
    ...
    const seeded = enqueueInAppNotice(enqueueInAppNotice(createInAppNoticeState(), first), second);
