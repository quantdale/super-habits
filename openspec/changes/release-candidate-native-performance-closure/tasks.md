...
- [x] 10.4 Post-RC gap audit → select the Weekly Review Cadence Loop as the next product campaign; its OpenSpec change and ExecPlan are active and implementation is complete.
