...
- [x] 1.4 Commit and push the coherent convergence milestone; record the exact SHA and branch relationship.
...
- [x] 3.1 Inspect and preserve existing native runner, EAS profile, prebuild stabilization, Maestro, and Windows/Nitro discovery conventions.
- [x] 3.2 Implement or compose a portable Android E2E build/install command with SDK/JDK/ADB/target preflight and useful failure diagnostics.
- [x] 3.3 Verify installed package, version/build identity, source SHA/provenance, target ABI/API, and replay context before native flow execution.
- [x] 3.4 Add deterministic error-path or reporting coverage for absent, stale, wrong-target, build, and install failures where practical.
