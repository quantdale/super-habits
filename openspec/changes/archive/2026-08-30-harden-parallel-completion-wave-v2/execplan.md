...
- Completed: Wave A shared layer + Wave B area swarms landed (commits c162716..f2ed6a6) and were repeatedly regression-proven by two successor hardening waves; migrations v20/v21 exist locally and are applied live (12-migration ledger verified 2026-08-22); Backup Scope V5 / settings V3 / portable format-2 shipped with validators, checksum/compat coverage, and simulation fixture parity; habit lifecycle, pomodoro metadata, workout provenance, notification actions, bulk/copy idempotency, and planning rollups are covered by green suites; full Playwright main suite green at this tree class (definitive 183/0); e2e:sync 46/46 PASS; deterministic simulation 22/22 PASS; timezone matrix PASS.
- Important modified files: Git is authoritative — see commits c162716..f2ed6a6 plus successor-wave commits; core areas are listed under Changed Files / Areas below.
- Remaining definition of done: Complete — every non-environment requirement in tasks.md is satisfied by cumulative evidence in the Validation Ledger; environment/access-gated residuals remain documented at their task lines.
- In progress: None.
