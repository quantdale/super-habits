...
This capability makes Android native certification repeatable for the current
source tree and proves the platform-sensitive Gym V2 persistence and durable
session behavior that web-only tests cannot establish.
