...
This capability makes the shipped Workout V2 model truthful and useful across
real training modalities, durable per-side work, progression, history, and
the existing SuperHabits planning surfaces.
