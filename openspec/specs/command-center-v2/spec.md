# command-center-v2 Specification

## Purpose

Define confirmation-first Command Center V2 mutations and bounded local/AI
read orchestration across the existing SuperHabits feature surfaces.
