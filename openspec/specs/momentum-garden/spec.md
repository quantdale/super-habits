# momentum-garden Specification

## Purpose

Define the local, deterministic Momentum Garden progress surface that combines
bounded cross-feature activity without telemetry or a punitive score.
