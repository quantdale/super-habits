# async-orchestration-determinism Specification

## Purpose

Define latest-only async state adoption, bounded remote bootstrap, monotonic
account/restore-preview sequencing, and lifecycle side-effect ownership across
SuperHabits.
