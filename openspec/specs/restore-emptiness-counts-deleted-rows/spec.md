# restore-emptiness-counts-deleted-rows Specification

## Purpose

TBD - created by archiving change fix-restore-emptiness-counts-deleted-rows. Update Purpose after archive.
