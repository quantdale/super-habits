# gym-workout-recovery-contract Specification

## Purpose

Define the migration, ownership, sync, Backup/Restore V2, Portable Backup, and
integrity contracts that keep expanded Gym training state recoverable while
preserving legacy and frozen historical formats.
