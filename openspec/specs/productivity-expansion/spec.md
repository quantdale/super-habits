# productivity-expansion Specification

## Purpose

Define the local Projects, Goals, Daily Planning, Planning Hub, Quick Capture,
Timeline, and Progress Insights expansion while preserving local-first safety.
