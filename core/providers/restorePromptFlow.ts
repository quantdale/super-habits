import type { RestoreExecutionResult, RestorePreview } from '@/core/sync/restore.types';
...
export function resolveRestorePromptOutcome(
  ...
  const directBlockedMessage = nonEmptyMessage(input.result.preview.eligibility.message);
