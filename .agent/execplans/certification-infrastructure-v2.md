...
- In progress: Wave 2 auth-mock automation — tooling implemented +
  tested (`--auth-mock` lifecycle, `--mock-auth-url` TEST-ONLY
  provision, 6 new proof tests); live auth-lane proof next.
