...
- Exact next action: Wave 8H repeat self-cert (controlled failing invocation) + 8I static matrix + Wave 8 closure commit (NO source changes after); then Wave 9 adversarial verification (must confront W8-1/W8-3/W8-4 honestly) + Wave 10 sweep (W8-4 probe + remaining P0/P1).
