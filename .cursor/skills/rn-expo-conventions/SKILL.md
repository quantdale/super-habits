...
- Sections: app/index.tsx renders all six sections (Today, To Do, Habits, Focus, Workout, Calories) behind a `NavigationContext.activeSection` state, with a section switcher of plain `Pressable` items
