...
| Concern         | File                                                                                            | Notes                                                                                                                                                                                                                                                                                                                                                                                     |
| --------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Persistence** | `core/db/client.ts`                                                                             | `getDatabase()`, `initializeDatabase()`, bootstrap DDL, **append-only** `runMigrations()` (`if (version < N)` blocks; current v11). WAL native-only. `schema.sql` = reference snapshot **hand-maintained from `client.ts`** (bootstrap DDL + every migration block), **not** runtime; `core/db/migrations/` holds remote/Supabase reference SQL only — local migrations never live there. |
