...
| Concern         | File                                                                                            | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------- | ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Persistence** | `core/db/client.ts`                                                                             | `getDatabase()`, `initializeDatabase()`, bootstrap DDL, **append-only** `runMigrations()` (`if (version < N)` blocks; current v24). WAL native-only. `schema.sql` = hand-maintained reference snapshot **not** runtime; it lags the runtime DDL (the runtime authority is `runMigrations()`); keep it aligned when touching tables it documents. `core/db/migrations/` holds remote/Supabase reference SQL only — local migrations never live there. |
