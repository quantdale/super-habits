...
- **Personas.** Six behavioural personas generate the nineteen journeys: P1 Maya (daily driver), P2 Tom (weekend returner), P3 Priya (power user), P4 Sam (error-prone), P5 Alex (commuter/offline), P6 Jordan (new-device migrator, including the Ask V2 deterministic boundary). A journey names its persona because the persona determines what the "realistic" behaviour is.
